...
class MessageViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, BackButtonDelegate {
    ...
    override func viewDidLoad() {
        ...
        let titleView = TitleView(frame: CGRect(x: 0, y: 0, width: kScreenWidth, height: titleHeight),type: .Message)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
            cell = MessageTableViewCell(style: .default, reuseIdentifier: "cell")
        }
        return cell!
    }
