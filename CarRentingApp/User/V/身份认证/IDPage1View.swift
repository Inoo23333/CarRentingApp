...
class IDPage1View: UIView {
    ...
    override init(frame: CGRect) {
        ...
        frontButton.frame = CGRect(x: 18, y: 152.5, width: (kScreenWidth-36-12)/2, height: 104.5)
//        frontButton.backgroundColor = .systemPink
        frontButton.addTarget(self, action: #selector(idFrontPic), for: .touchDown)
        ...
        backButton.frame = CGRect(x: (kScreenWidth-36-12)/2+30, y: 152.5, width: (kScreenWidth-36-12)/2, height: 104.5)
//        backButton.backgroundColor = .orange
        backButton.addTarget(self, action: #selector(idFrontPic), for: .touchDown)
    ...
    @objc func idFrontPic() {
        self.delegate?.toIdFrontPic()
    }
    
    @objc func idBackPic() {
        self.delegate?.toIdBackPic()
    }
}
