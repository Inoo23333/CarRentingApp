...
class PositonViewController: UIViewController, BackButtonDelegate {
    ...
    override func viewDidLoad() {
        ...
        let titleView = TitleView(frame: CGRect(x: 0, y: 0, width: kScreenWidth, height: titleHeight),title: "归还车辆")
